...
(function(root){
  ...
  var SETS = {
    ...
    "coursier_du_nexus": {"name": "Coursier du Nexus", "rarity": "common", "items": ["visiere_messager", "sac_coursier_bandouliere", "baskets_skyyart"], "bonuses": {"3": {"stats": {"speed": 3, "agility": 2}}}},
    ...
    "filament_cyan": {"name": "Filament Cyan", "rarity": "rare", "items": ["filament_cyan_capuche", "filament_cyan_veste", "filament_cyan_gants", "filament_cyan_brassards", "filament_cyan_bottes", "filament_cyan_dagues"], "bonuses": {"2": {"stats": {"agility": 5}}, "4": {"stats": {"agility": 12}}, "6": {"stats": {"agility": 22}}}},
    ...
    "spectre_veloce": {"name": "Spectre Véloce", "rarity": "rare", "items": ["spectre_veloce_capuche", "spectre_veloce_combinaison", "spectre_veloce_gants", "spectre_veloce_bottes", "spectre_veloce_cape", "spectre_veloce_lames"], "bonuses": {"2": {"stats": {"agility": 4, "speed": 4}}, "4": {"stats": {"agility": 10, "speed": 10}}, "6": {"stats": {"agility": 18, "speed": 18}}}},
    ...
    "predateur_urbain": {"name": "Prédateur Urbain", "rarity": "rare", "items": ["casque_combat_spectre", "combinaison_furtive_ombre", "souliers_semelles_silence"], "bonuses": {"3": {"stats": {"agility": 10, "speed": 5}}}},
    ...
    "executeur": {"name": "Exécuteur", "rarity": "epic", "items": ["casque_executeur_nexus", "dagues_jumelles_assassin", "cape_dephasage"], "bonuses": {"3": {"stats": {"agility": 15, "intelligence": 10}}}},
    ...
    "phantom_edge": {"name": "Phantom Edge", "rarity": "legendary", "items": ["phantom_edges_cowl", "phantom_edges_bracers", "phantom_edges_stiletto"], "bonuses": {"2": {"stats": {"agility": 20}}, "3": {"stats": {"agility": 45}, "buff_mult": {"agility": 1.3}}}},
    "roi_loup": {"name": "Roi-Loup", "rarity": "legendary", "items": ["collier_roi_loup_blanc", "crocs_basilic_ombre", "anneau_chronos"], "bonuses": {"3": {"stats": {"strength": 18, "agility": 18}}}},
    ...
    "time_paradox": {"name": "Time Paradox", "rarity": "unique", "items": ["time_paradox_ring", "time_paradox_watch"], "bonuses": {"2": {"stats": {"speed": 25, "agility": 25}}}},
